...
import { Loader2, Package, CheckCircle, XCircle, Clock, Truck, DollarSign, Users, Store, AlertTriangle } from "lucide-react";
...
function VendorDashboard() {
  const { data: summary, isLoading } = useGetVendorDashboardSummary();
  ...
  return (
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold">Rs. {summary.payableBalance.toLocaleString()}</div>
        </CardContent>
      </Card>
    </div>
  );
